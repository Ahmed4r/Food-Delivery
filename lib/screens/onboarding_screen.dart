...
class OnboardingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedIntroduction(
      ...
      containerBg:
          isDark ? AppColors.secondary : AppColors.white, //background color
      textColor:
          isDark ? AppColors.white : Colors.white, //text color : lightmode
      footerBgColor: isDark
          ? AppColors.black
          : Colors.deepOrange, //footer container background color
